...
async function guardarTokenRecuperacao(idUtilizador, token) {
    try {
        ...
        const query = `
            ...
            VALUES (@Token, DATEDIFF(SECOND, '1970-01-01', DATEADD(HOUR, 1, GETUTCDATE())), 0, GETDATE(), @IdUtilizador);
        `;
        await pool.request()
...
// ============================================================================
// 4. MAPEMENTO DE ENCARREGADOS E ALUNOS (US05 / RF05)
// ============================================================================

/**
 * Lista os alunos associados a um encarregado para o formulário de marcação.
 */
